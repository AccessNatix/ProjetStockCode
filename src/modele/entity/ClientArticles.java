...
@NamedQueries({
    ...
    @NamedQuery(name = "ClientArticles.removeAll", query = "DELETE FROM ClientArticles c"),
    ...
    @NamedQuery(name = "ClientArticles.removeByClientId", query = "DELETE FROM ClientArticles c WHERE c.clientId.id = :clientId"),
